    ...
    <ul class="menu__media">
      <li class="menu__media__item" @click="showEmailOverlay">
        <span class="menu__media__item__link">
          <svg
            class="menu__media__item__link__icon"
      ...
      <li class="menu__media__item">
        <a
          href="https://www.linkedin.com/in/jakub-lewandowski-011001"
          target="_blank"
          class="menu__media__item__link"
        >
          <svg
            class="menu__media__item__link__icon"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li class="menu__media__item">
        <a
          href="https://github.com/JacobLewandowskiDev"
          target="_blank"
          class="menu__media__item__link"
          style="width: 1.5rem"
        >
...
.menu__media__item:hover {
  ...
  box-shadow: 0px 0px 0.8rem rgba(255, 255, 255, 0.4);
}
